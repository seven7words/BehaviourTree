namespace BehaviorDesigner.Editor
{
    ...
    public class BehaviorDesignerPreferences : Editor
    {
        ...
        public static void DrawPreferencesPane(PreferenceChangeHandler callback)
        {
            ...
            if (EditorGUILayout.Popup("Serialization", !@bool ? 1 : 0, serializationString, Array.Empty<GUILayoutOption>()) != (!@bool ? 1 : 0))
            {
            ...
            Behavior.GizmoViewMode num2 = (Behavior.GizmoViewMode) EditorGUILayout.EnumPopup("Gizmos View Mode", (Behavior.GizmoViewMode) @int, Array.Empty<GUILayoutOption>());
            if ((int)num2 != @int)
            {
                SetInt(BDPreferences.GizmosViewMode, (int)num2 );
                callback(BDPreferences.GizmosViewMode, num2);
            }
            @int = GetInt(BDPreferences.QuickSearchKeyCode);
            num2 = (Behavior.GizmoViewMode) EditorGUILayout.EnumPopup("Quick Search Key Code", (KeyCode) @int, Array.Empty<GUILayoutOption>());
            if ((int)num2 != @int)
            {
                SetInt(BDPreferences.QuickSearchKeyCode, (int)num2);
                callback(BDPreferences.QuickSearchKeyCode, num2);
            }
            float @float = GetFloat(BDPreferences.ZoomSpeedMultiplier);
            float num4 = EditorGUILayout.Slider("Zoom Speed Multiplier", @float, 0.1f, 4f, Array.Empty<GUILayoutOption>());
            if (@float != num4)
            {
        ...
        public static bool GetBool(BDPreferences pref)
        {
            ...
            {
                @bool = EditorPrefs.GetBool(PrefString[(int) pref]);
        ...
        public static float GetFloat(BDPreferences pref)
        {
            ...
            {
                @float = EditorPrefs.GetFloat(PrefString[(int) pref], 1f);
        ...
        public static int GetInt(BDPreferences pref)
        {
            ...
            {
                @int = EditorPrefs.GetInt(PrefString[(int) pref]);
        ...
        public static void InitPrefernces()
        {
            ...
            if (!EditorPrefs.HasKey(PrefString[0x12]))
            {
                SetBool(BDPreferences.AddGameGUIComponent, false);
            }
            if (!EditorPrefs.HasKey(PrefString[0x13]))
            {
